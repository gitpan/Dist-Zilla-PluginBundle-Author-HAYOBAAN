...
#pod L<Dist::Zilla> plugins according to HAYOBAAN's preferences.
#pod
#pod =head1 USAGE
#pod
#pod   # In dist.ini
...
#pod
#pod Additional test plugin to use. Can be used multiple times.
#pod
...
#pod
#pod Specifies the tests you don't want to run.
#pod
